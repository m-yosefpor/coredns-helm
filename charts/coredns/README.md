...
| `autoscaler.podSecurityContext`                | Pod level securityContext for the autoscaler                                                                                              | {}                                                           |
| `autoscaler.securityContext`                   | Container securityContext for the autoscaler                                                                                              | allowPrivilegeEscalation false, readOnlyRootFilesystem true, privileged false |
